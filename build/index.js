...
resetData(true);
printMsg(chalk.magentaBright.bold("Hey there! Let's get started with the guessing number game! I've generated a random number from 0-9. It's your tuem to guess it."));
do {
    await makeGuess();
} while (checkConfirm);
printMsg(`Great to have you here! Your final score is: ${chalk.green(score)} of ${chalk.blue(numbeOfGames)} games.\nI'll wait for you again! Bye!!!`);
